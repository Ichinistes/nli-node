let Conf,Table,configKey,validateApiKey,validateCityId,validateUnits,queryWeatherForecast;_a0b‍.x([["forecast",()=>forecast]]);_a0b‍.w("conf",[["default",["Conf"],function(v){Conf=v}]]);_a0b‍.w("cli-table3",[["default",["Table"],function(v){Table=v}]]);_a0b‍.w("./configure",[["configKey",["configKey"],function(v){configKey=v}]]);_a0b‍.w("./utils",[["validateApiKey",["validateApiKey"],function(v){validateApiKey=v}],["validateCityId",["validateCityId"],function(v){validateCityId=v}],["validateUnits",["validateUnits"],function(v){validateUnits=v}],["queryWeatherForecast",["queryWeatherForecast"],function(v){queryWeatherForecast=v}]]);
    ...
    _a0b‍.g.console.log(table.toString());
}
